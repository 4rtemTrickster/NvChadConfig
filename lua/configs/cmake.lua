require("cmake-tools").setup {
    ...
    --       ${kitGenerator}
    --       ${variant:xx}
    cmake_build_directory = "out\\build\\${variant:buildType}", -- this is used to specify generate directory for cmake, allows macro expansion, relative to vim.loop.cwd()
